...
const moonTab = document.getElementById('moon').addEventListener('click' , (e) => {
    handleDestination(e.target.id);
});

const marsTab = document.getElementById('mars').addEventListener('click' , (e) => {
    handleDestination(e.target.id)
});

const europaTab = document.getElementById('europa').addEventListener('click', (e) => {
    handleDestination(e.target.id);
});

const titanTab = document.getElementById('titan').addEventListener('click', (e) =>{
    handleDestination(e.target.id);
});
